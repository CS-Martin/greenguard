...
@section('content')
    <div class="px-6 h-[100vh] flex items-center justify-center h-screen">
        <div class="w-full">
            <img src="{{ asset('assets/logo.png') }}" alt="" class="mx-auto" width="200">
            <img src="{{ asset('assets/agricon-transparent-logo.png') }}" alt="" class="mx-auto mb-16" width="130">
            ...
            <form class="w-full" action="" method="POST">
                ...
                <button type="submit"
                    class="text-white bg-[#1CB87E] hover:bg-[#168a5f] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-4 text-center mb-6">Sign
                    In</button>
